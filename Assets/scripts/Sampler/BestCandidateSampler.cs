...
namespace DistributionPrototype {
    public class BestCandidateSampler {
        ...
        //private int k = 1; // initial number of candidates to consider per circle
        private int m = 10; // initial number of circles to add per frame
        private int n = 2500; // remaining number of circles to add

        public BestCandidateSampler(float width, float height, float padding, float minRadius, float maxRadius) {
        ...
        public void GetCircle(int k) {
            //float bestX = 0, bestY = 0, bestDistance = 0;

            //for (var i = 0; i < k || bestDistance < padding; ++i) {
            //    float x = Random.value * _width,
            //    y = Random.value * _height,
            //    rx1 = x - searchRadius,
            //    rx2 = x + searchRadius,
            //    ry1 = y - searchRadius,
            //    ry2 = y + searchRadius,
