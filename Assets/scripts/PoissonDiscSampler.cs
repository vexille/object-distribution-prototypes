    ...
    public IEnumerable<Vector2> Samples() {
        ...
        while (_activeSamples.Count > 0) {
            ...
            for (int j = 0; j < k; ++j) {
                ...
                float r = Mathf.Sqrt(Random.value * 3 * rad + rad);// *Mathf.PerlinNoise(sample.x, sample.y); // See: http://stackoverflow.com/questions/9048095/create-random-number-within-an-annulus/9048443#9048443
